	...
	public static RCC_Inputs GetInputs(){
		...
		case RCC_Settings.ControllerType.XBox360One:
			...
			if(!string.IsNullOrEmpty(RCC_Settings.Instance.Xbox_triggerRightInput))
				inputs.throttleInput = ControlFreak2.CF2Input.GetAxis (RCC_Settings.Instance.Xbox_triggerRightInput);

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.Xbox_triggerLeftInput))
				inputs.brakeInput = ControlFreak2.CF2Input.GetAxis (RCC_Settings.Instance.Xbox_triggerLeftInput);

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.Xbox_horizontalInput))
				inputs.steerInput = ControlFreak2.CF2Input.GetAxis (RCC_Settings.Instance.Xbox_horizontalInput);

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.Xbox_handbrakeKB))
				inputs.handbrakeInput = ControlFreak2.CF2Input.GetButton (RCC_Settings.Instance.Xbox_handbrakeKB) ? 1f : 0f;

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.Xbox_boostKB))
				inputs.boostInput = ControlFreak2.CF2Input.GetButton(RCC_Settings.Instance.Xbox_boostKB) ? 1f : 0f;
		...
		case RCC_Settings.ControllerType.PS4:
			...
			if(!string.IsNullOrEmpty(RCC_Settings.Instance.PS4_triggerRightInput))
				inputs.throttleInput = Mathf.Clamp01(ControlFreak2.CF2Input.GetAxis(RCC_Settings.Instance.PS4_triggerRightInput));

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.PS4_triggerLeftInput))
				inputs.brakeInput = ControlFreak2.CF2Input.GetAxis(RCC_Settings.Instance.PS4_triggerLeftInput);

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.PS4_horizontalInput))
				inputs.steerInput = ControlFreak2.CF2Input.GetAxis(RCC_Settings.Instance.PS4_horizontalInput);

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.PS4_handbrakeKB))
				inputs.handbrakeInput = ControlFreak2.CF2Input.GetButton(RCC_Settings.Instance.PS4_handbrakeKB) ? 1f : 0f;

			if(!string.IsNullOrEmpty(RCC_Settings.Instance.PS4_boostKB))
				inputs.boostInput = ControlFreak2.CF2Input.GetButton(RCC_Settings.Instance.PS4_boostKB) ? 1f : 0f;
...
//			inputs.handbrakeInput = "yourValue";
	...
	public static bool GetKeyUp(KeyCode keyCode){
		...
		if (ControlFreak2.CF2Input.GetKeyUp (keyCode))
			return true;
	...
	public static bool GetKey(KeyCode keyCode){
		...
		if (ControlFreak2.CF2Input.GetKey (keyCode))
			return true;
	...
	public static bool GetButtonDown(string buttonCode){
		...
		if (ControlFreak2.CF2Input.GetButtonDown (buttonCode))
			return true;
	...
	public static bool GetButtonUp(string buttonCode){
		...
		if (ControlFreak2.CF2Input.GetButtonUp (buttonCode))
			return true;
	...
	public static bool GetButton(string buttonCode){
		...
		if (ControlFreak2.CF2Input.GetButton (buttonCode))
			return true;
